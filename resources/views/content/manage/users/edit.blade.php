        ...
        <div class="card-body">
            ...
            <form action="{{ route('manage.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('avatar') is-invalid @enderror" type="file" id="field-avatar" name="avatar" accept="image/*">
                    @error('avatar')
                ...
                <div class="mb-3">
                    ...
                    <input type="name" class="form-control @error('name') is-invalid @enderror" id="field-name" aria-describedby="field-nameFeedback" placeholder="John Doe" name="name" value="{{ $user->name }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="field-email" aria-describedby="field-emailFeedback" placeholder="name@example.com" name="email" value="{{ $user->email }}">
                    @error('email')
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control @error('password') is-invalid @enderror" aria-describedby="field-passwordFeedback" id="field-password" name="password">
                    @error('password')
