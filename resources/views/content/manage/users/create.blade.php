        ...
        <div class="card-body">
            ...
            <form action="{{ route('manage.users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="name" class="form-control @error('name') is-invalid @enderror" id="field-name" aria-describedby="field-nameFeedback" placeholder="John Doe" name="name" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="field-email" aria-describedby="field-emailFeedback" placeholder="name@example.com" name="email" value="{{ old('email') }}">
                    @error('email')
