...
@section('title', 'Manage Device | Roost Control')
            ...
            <form action="{{ route('manage.devices.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('id') is-invalid @enderror" id="field-id" aria-describedby="btnDeviceID" placeholder="Ex: AB0001" name="id" value="{{ old('id') }}" maxlength="6">
                        <button class="btn btn-outline-primary" type="button" onclick="generateRandomString('#field-id')" id="btnDeviceID">Generate ID</button>
                        @error('id')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="field-name" aria-describedby="field-nameFeedback" placeholder="Ex: Kandang Ayam Umur 7 - 14 Hari" name="name" value="{{ old('name') }}">
                    @error('name')
