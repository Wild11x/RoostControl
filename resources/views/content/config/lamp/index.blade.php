            ...
            <form action="{{ route('config.lamp.update') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="time" class="form-control @error('time_on') is-invalid @enderror" id="field-timeon" aria-describedby="field-timeonFeedback" name="time_on" value="{{ old('time_on') ?? $config->time_on }}" onfocus="this.showPicker()">
                        @error('time_on')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" class="form-control @error('time_off') is-invalid @enderror" id="field-timeoff" aria-describedby="field-timeoffFeedback" name="time_off" value="{{ old('time_off') ?? $config->time_off }}" onfocus="this.showPicker()">
                        @error('time_off')
